...
function add_feature()
{
    ...
    { 
        ...
        {
            alert('success','Tiện nghi mới đã được thêm!');
...
function rem_feature(val)
{
    ...
    if(this.responseText==1)
    {
        alert('success','Tiện nghi đã được xóa!');
        get_features();
    }
    else if(this.responseText == 'room_added')
    {
        alert('error','Tiện nghi đã được thêm vào phòng!')
    }
    else
    {
        alert('error','Máy chủ đang gặp sự cố hoặc không hoạt động!')
...
function add_facility()
{
    ...
    { 
        ...
        {
            alert('error','Chỉ cho phép SVG!');
        }
        else if(this.responseText == 'inv_size')
        {
            alert('error','Hình ảnh cần có kích thước nhỏ hơn 1MB!');
        }
        ...
        {
            alert('success','Cơ sở vật chất mới đã được thêm!');
