...
function upd_shutdown(val)
{
    ...
    { 
        ...
        {
            alert('success', 'Trang web đã bị tắt trạng thái hoạt động');
        }
        else
        {
            alert('success', 'Chế độ tắt trạng thái không hoạt động đã bị tắt!');
        }
        get_general();
    }
...
function add_member()
{
    ...
    { 
        ...
        {
            alert('success','Thành viên mới đã được thêm!');
