...
<h6 class="text-center bg-dark text-white p-3 m-0">Được thiết kế và phát triển bởi SUMI WEBDEV</h6>
...
<script>
    ...
    register_form.addEventListener('submit', (e)=>
    {
        ...
        { 
            ...
            {
                alert('error',"Email đăng ký đã tồn tại!");
            }
            else if(this.responseText == 'phone_already')
            {
                alert('error',"Số điện thoại đăng ký đã tồn tại!")
            }
            else if(this.responseText == 'inv_img')
            {
                alert('error',"Chỉ nhận file hình JPG, WEBP & PNG!");
            }
            ...
            {
                alert('error',"Không gửi được Email!");
            }
            else if(this.responseText == 'ins_failed')
            {
                alert('error',"Đăng ký tài khoản thất bại!");
            }
            else
            {
    ...
    login_form.addEventListener('submit', (e)=>
    {
        ...
        { 
            ...
            {
                alert('error',"Email hoặc SĐT không hợp lệ!");
            }
            else if(this.responseText == 'not_verified')
            {
                alert('error',"Email đăng nhập chưa xác thực!");
            }
            else if(this.responseText == 'inactive')
            {
                alert('error',"Tài khoản đã bị đình chỉ. Vui lòng liên hệ với quản trị viên!")
            }
    ...
    function checkLoginToBook(status,room_id)
    {
        ...
        {
            alert('error','Hãy đăng nhập để đặt phòng!');
        }
    }
