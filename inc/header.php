            ...
            <form id="register-form">
                ...
                <div class="modal-body">
                    <span class="badge rounded-pill bg-light text-dark text-wrap lh-base">
                        Chú ý: Thông tin chi tiết của bạn phải khớp với ID của bạn (CCCD, hộ chiếu, giấy phép lái xe, v.v.).
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="forgot-form">
                ...
                <span class="badge rounded-pill bg-light text-dark text-wrap lh-base">
                        Chú ý: Một liên kết sẽ gửi đến mail của bạn giúp bạn khôi phục mật khẩu!
                </span>
                <div class="modal-body">
                    <div class="mb-4">
                        <label class="form-label">Email</label>
