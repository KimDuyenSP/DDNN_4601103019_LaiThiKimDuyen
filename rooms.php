...
<body class="bg-light">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12 mb-lg-0 mb-4 px-4">
                    ...
                    <div class="container-fluid flex-lg-column align-items-stretch">
                        ...
                        <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="d-flex align-items-center justify-center-between mb-3" style="font-size: 18px">
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="d-flex align-items-center justify-center-between mb-3" style="font-size: 18px">
                                     ...
                                     <button  id="guests_btn" onclick="guests_clear()" class="btn shadow-none btn-sm text-secondary d-none">Làm mới</button>
                                </h5>
                                <div class="d-flex">
                                    <div class="me-2">
            ...
            <div class="col-lg-8 col-md-12 px-4" id="rooms-data">
