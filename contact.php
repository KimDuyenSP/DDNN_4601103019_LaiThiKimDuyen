...
<body class="bg-light">
    ...
    <div class="my-5 px-4">
        ...
        <p class="text-center mt-3">
            Liên lạc với khách sạn có thể thông qua số điện thoại, email <br> hoặc truy cập trang web của khách sạn để đặt phòng hoặc yêu cầu thông tin.
        </p>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 mb-5 px-4">
                ...
                <div class="bg-white rounded shadow p-4">
                    ...
                    <a href="Gửi đến mail: <?php echo $contact_r['email'] ?>" class= "d-inline-block text-decoration-none text-dark">
            ...
            <div class="col-lg-6 col-md-6 px-4">
                <div class="bg-white rounded shadow p-4">
                    <form method="POST">
                        ...
                        <div class="mt-3">
                            <label class="form-label" style="font-weight: 500">Nội dung tin nhắn</label>
    ...
    <?php
        if(isset($_POST['send']))
        {
            ...
            {
                alert('error','Máy chủ không hoạt động! Vui lòng thử lại sau.');
            }
        }
    ?>
